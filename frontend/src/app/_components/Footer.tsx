  ...
  return (
    <footer className="max-w-screen bg-emerald-900 text-white dark:bg-emerald-950">
      ...
      <div className="px-4 py-6 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
        <span className="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2025 <a href="https://iiitbh.ac.in/">Swach Setu™</a>. All Rights Reserved.
        </span>
...
export default Footer; import Image from 'next/image';
import Link from 'next/link';
import React from 'react';
      ...
      <div className="w-screen ">
        <Link href="/" className="flex items-center gap-4">
          <Image
            ...
            width={50}
            height={39}
            className="mx-4 mt-4 rounded-full object-contain"
          />
        </Link>
        <div className="grid grid-cols-2 gap-8 px-4 pb-6 pt-2 lg:pb-8 lg:pt-2 md:grid-cols-4">
          <div>
